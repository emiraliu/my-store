    ...
    <>
      <button
        ...
        style={{
          ...
          fontFamily: F.body, fontSize: 12, color: '#000000',
        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontFamily: F.mono, fontSize: 9, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#6e6e6e', marginBottom: 4 }}>
                  Order
                </div>
                <div style={{ fontFamily: F.display, fontSize: 26, fontWeight: 500, lineHeight: 1.1 }}>
                  #{order.id.slice(0, 8).toUpperCase()}
                </div>
                <div style={{ fontFamily: F.mono, fontSize: 10, color: '#6e6e6e', marginTop: 4 }}>
                  {date} · {time}
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <span style={{
                  ...
                  textTransform: 'uppercase', color: '#6e6e6e',
                ...
                <button
                  ...
                  style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    cursor: 'pointer', color: '#000000', fontSize: 16, lineHeight: 1,
                  }}
                >
                  ×
                </button>
            ...
            <div style={{ overflowY: 'auto', padding: '20px 22px', display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {/* Customer section */}
              <section>
                <div style={{ fontFamily: F.mono, fontSize: 9, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#6e6e6e', marginBottom: 10 }}>
                  Customer
                </div>
                <div style={{
                  ...
                  {[
                    ...
                    <div key={label} style={{
                      ...
                      <span style={{ fontFamily: F.mono, fontSize: 10, color: '#6e6e6e', letterSpacing: '0.04em' }}>{label}</span>
              ...
              <section>
                <div style={{
                  ...
                  <span style={{ fontFamily: F.mono, fontSize: 10, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.6)' }}>
                    Total · Cash on delivery
                  </span>
                  <span style={{ fontFamily: F.mono, fontSize: 16, fontWeight: 500, color: '#ffffff' }}>
