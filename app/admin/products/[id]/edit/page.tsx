    ...
    <div style={{ fontFamily: F.body, color: '#000000' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: F.mono, fontSize: 10, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#6e6e6e' }}>
          ...
          <strong style={{ color: '#000000', fontWeight: 500 }}>Edit</strong>
        </div>
      </div>
      ...
      <div style={{ padding: '28px 28px 60px', maxWidth: 600 }}>
        <h1 style={{
          ...
          Edit product<em style={{ fontStyle: 'italic', color: '#000000' }}>.</em>
        </h1>
        <p style={{ fontFamily: F.mono, fontSize: 10, color: '#6e6e6e', letterSpacing: '0.06em', textTransform: 'uppercase', margin: '0 0 28px' }}>
